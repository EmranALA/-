const CACHE_NAME = 'halaqa-cache-v11-vite';
...
const PRECACHE_ASSETS = [
    ...
    '/manifest.json',
    '/metadata.json',
    // Key src files, Vite build will handle hashing and full lists
    '/src/index.tsx', 
    '/src/App.tsx',
    'https://cdn.tailwindcss.com', // Kept for stale-while-revalidate for Tailwind CDN in original file
